...
from app.report.payloads import (
...
REPORT_TERMS = {
    "hero": {
        ...
        "subtitle": "Run evaluation for the active Open Food Facts data quality checks. Strict comparison is shown where a legacy baseline exists.",
        "export_as": "Export as",
        "export_pdf": "PDF",
        "export_html": "HTML",
        "export_json": "JSON",
