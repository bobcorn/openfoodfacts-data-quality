...
from examples.google_sheets_demo.data_sources import load_csv_table
from examples.google_sheets_demo.models import TableData
...
GOOGLE_CLIENT_ID_ENV_VAR = "GOOGLE_SHEETS_DEMO_GOOGLE_CLIENT_ID"
GOOGLE_API_KEY_ENV_VAR = "GOOGLE_SHEETS_DEMO_GOOGLE_API_KEY"
GOOGLE_CLOUD_PROJECT_NUMBER_ENV_VAR = "GOOGLE_SHEETS_DEMO_GOOGLE_CLOUD_PROJECT_NUMBER"
DEFAULT_DATA_SHEET_NAME = "Data"
DEFAULT_READY_SHEET_NAME = "Ready for OFF upload"
...
class PublicDemoConfig:
    ...
    def to_payload(self) -> dict[str, str]:
        return {
            ...
            "dataSheetName": self.data_sheet_name,
            "readySheetName": self.ready_sheet_name,
        }


def build_public_demo_config(environ: Mapping[str, str]) -> PublicDemoConfig:
    """Build the public browser config for one demo app instance."""
    return PublicDemoConfig(
        ...
        data_sheet_name=DEFAULT_DATA_SHEET_NAME,
        ready_sheet_name=DEFAULT_READY_SHEET_NAME,
    )
